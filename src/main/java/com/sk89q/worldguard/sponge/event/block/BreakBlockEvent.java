...
public class BreakBlockEvent extends AbstractBlockEvent {
    ...
    public BreakBlockEvent(@Nullable Event originalEvent, Cause cause, Location block) {
        super(originalEvent, cause, block);
    }

    public BreakBlockEvent(@Nullable Event originalEvent, Cause cause, Location target, BlockType  effectiveMaterial) {
